...
Всю теорию и оснонвые методы, функции, параметры для создания бота я перепишу в тетардь и буду оттуда пользоваться, чтобы не заглядывать в инет каждый раз
